	...
	public static class RegistryEvents {
		...
		public static void registerItems(final RegistryEvent.Register<Item> event) {
			event.getRegistry().registerAll(
					thunderfury = new SwordItem(ItemTier.DIAMOND, 0, 6.0f, new Item.Properties().group(WoWTabs.WoWItemGroup))
							.setRegistryName(location("thunderfury")),
					new SwordItem(ItemTier.DIAMOND, 0, 6.0f, new Item.Properties().group(WoWTabs.WoWItemGroup))
