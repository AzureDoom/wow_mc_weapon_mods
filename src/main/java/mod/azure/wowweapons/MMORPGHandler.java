...
public class MMORPGHandler {
	...
	public static void registerMMORPG() {
		...
		MineAndSlashAPI.addCompatibleItem("wowweapons:doomfinger", new Level60ConfigItem().setType(new Staff()).setMaxRarity(4).setMinRarity(4));
		MineAndSlashAPI.addCompatibleItem("wowweapons:anzusscorn", new ConfigItem().setType(new Staff()).setMaxRarity(2).setMinRarity(2));
		MineAndSlashAPI.addCompatibleItem("wowweapons:thunderfury", new Level57ConfigItem().setType(new Sword()).setMaxRarity(5).setMinRarity(5));
